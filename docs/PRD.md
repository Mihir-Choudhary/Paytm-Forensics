...
- **Freelist/slack carving roughly doubles** the recoverable transaction and counterparty
  records versus reading live rows only.
...
- Carving recovers ≥ the counts observed in manual analysis (≈2× live transactions/counterparties).
